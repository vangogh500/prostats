...
exports.get = function() {
	crawler.get('http://matchhistory.na.leagueoflegends.com/en/#match-details/TRLH1/30030?gameHash=fbb300951ad8327c&tab=overview', function($matchHistory) {
		console.log($matchHistory.html());
	});
};